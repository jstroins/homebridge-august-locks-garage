...
(function (AugustLockStatus) {
    AugustLockStatus[AugustLockStatus["LOCKED"] = 0] = "LOCKED";
    AugustLockStatus[AugustLockStatus["UNLOCKED"] = 1] = "UNLOCKED";
    AugustLockStatus[AugustLockStatus["UNKNOWN"] = 2] = "UNKNOWN";
    ...
    const req = (0, https_1.request)(options, res => {
      ...
      res.on('end', () => {
        ...
        try {
          ...
          log.error('Failed to parse response as JSON:', body);
          return reject(err);
        }
