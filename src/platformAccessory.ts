...
class AugustSmartLockAccessory {
    constructor(platform, accessory) {
        ...
        this.locked = august_1.AugustLockStatus.LOCKED;
    ...
    async setMock(value) {
        ...
        this.locked = value === this.platform.Characteristic.LockTargetState.SECURED ? august_1.AugustLockStatus.LOCKED : august_1.AugustLockStatus.UNLOCKED;
    }
    async getMock() {
        const results = this.locked === august_1.AugustLockStatus.LOCKED
    ...
    async setOn(value) {
        ...
        if (this.platform.Session) {
            const status = value === this.platform.Characteristic.LockTargetState.SECURED ? august_1.AugustLockStatus.LOCKED : august_1.AugustLockStatus.UNLOCKED;
            try {
    ...
    async updateStatus() {
        ...
        (0, august_1.augustGetLockStatus)(this.platform.Session, id, this.platform.log).then((status) => {
            ...
            const currentState = status === august_1.AugustLockStatus.LOCKED
                ? this.platform.Characteristic.LockCurrentState.SECURED
                : status === august_1.AugustLockStatus.UNLOCKED
                    ? this.platform.Characteristic.LockCurrentState.UNSECURED
